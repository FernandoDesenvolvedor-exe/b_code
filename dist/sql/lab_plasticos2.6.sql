...
(1, 'adm adm', 1, '', '', 1, 'Etil-benzeno', 'Virgem', 'Comodities', 'CRISTAL MASTER', 'Amarelo', 'MTB', '', 0, 'COLORFIX', 'garrafinha', 'GAR8421588', 'Madeira', 'VF-32', 120, NULL, NULL, 1800, 600, '2023-12-03 21:01:09', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', ''),
(1, 'adm adm', 1, '', '', 1, 'Poliéster', 'Virgem', 'Comodities', 'QUIMIOTEC', 'Amarelo', 'MTB', '', 0, 'COLORFIX', 'garrafinha', 'GAR8421588', 'Madeira', 'VF-32', 120, NULL, NULL, 1800, 600, '2023-12-03 21:01:09', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', ''),
(2, 'adm adm', 1, '', '', 2, 'Etil-benzeno', 'Virgem', 'Comodities', 'CRISTAL MASTER', 'Amarelo', 'MTB', '', 0, 'COLORFIX', 'garrafinha', 'GAR8421588', 'Madeira', 'Pendente', 50, NULL, NULL, 750, 250, '2023-12-03 23:27:16', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', ''),
(2, 'adm adm', 1, '', '', 2, 'Poliéster', 'Virgem', 'Comodities', 'QUIMIOTEC', 'Amarelo', 'MTB', '', 0, 'COLORFIX', 'garrafinha', 'GAR8421588', 'Madeira', 'Pendente', 50, NULL, NULL, 750, 250, '2023-12-03 23:27:16', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', '');
...
(1, 5, 2, 1, '2023-12-03 21:01:09', '2023-12-03 22:54:10', NULL, 2, '', NULL, 120, NULL),
(2, 5, 2, NULL, '2023-12-03 23:27:16', NULL, NULL, 1, '', NULL, 50, NULL);
...
--
-- Estrutura stand-in para view `veiw_altera_estoque`
-- (Veja abaixo para a visão atual)
--
CREATE TABLE `veiw_altera_estoque` (
`idPedido` int(11)
,`producao` int(11)
,`qtdMaterial` int(11)
,`qtdPigmento` float
...
--
ALTER TABLE `pedidos`
  MODIFY `idPedido` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK - chave identificadora de IDs da tabela pedidos', AUTO_INCREMENT=3;
COMMIT;
