...
/*criado tabela historico_materia_prima*/;
...
INSERT INTO `historico` (`idHistorico`, `nomeUsuario`, `tipoUsuario`, `turma`, `turno`, `idPedido`, `materiaPrima`, `tipoMateria_prima`, `classeMateria_prima`, `pigmento`, `tipoPigmento`, `produto`, `maquina`, `producaoPrevista`, `refugo`, `producaoRealizada`, `quantidadeMateria_prima`, `quantidadePigmento`, `dataHora_aberto`, `dataHora_producao`, `dataHora_fechado`, `dataHora_alterado`, `statusPedido`, `obsPedido`, `ativo`) VALUES
...
CREATE TABLE `historico_materia_prima` (
  ...
  `idUsuario` int(11) NOT NULL COMMENT 'Registra o Id do usuário que fez a alteração no estoque de matéria prima',
  `nomeUsuario` varchar(80) NOT NULL COMMENT 'Registra o nome do usuário.',
  `sobrenomeUsuario` varchar(80) NOT NULL COMMENT 'Registra o sobrenome do usuário.',
...
CREATE TABLE `pedidos` (
  ...
  `producaoPrevista` int(11) NOT NULL COMMENT 'Registra a quantidade de produtos selecionadas no pedido',
...
--
ALTER TABLE `historico`
  MODIFY `idHistorico` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave identificadora de registros da tabela histórico', AUTO_INCREMENT=18;
...
--
ALTER TABLE `pedidos`
  MODIFY `idPedido` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK - chave identificadora de IDs da tabela pedidos', AUTO_INCREMENT=51;
