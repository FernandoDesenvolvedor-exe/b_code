...
--
-- Host: 127.0.0.1
-- Tempo de geração: 07/11/2023 às 22:31
...
INSERT INTO `pedidos` (`idPedidos`, `idUsuario`, `idReceita`, `idMaquina`, `dataHora_aberto`, `dataHora_fechado`, `status`, `observacoes`, `quantidade`, `ativo`) VALUES
(1, 4, 2, 1, '2023-11-07 17:19:29', '0000-00-00 00:00:00', 2, '', 60, 1),
(2, 5, 1, 1, '2023-11-07 17:24:39', '0000-00-00 00:00:00', 2, '', 60, 1);
...
--
ALTER TABLE `pedidos`
  MODIFY `idPedidos` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK - chave identificadora de IDs da tabela pedidos', AUTO_INCREMENT=3;
