...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Nov-2023 às 00:43
...
CREATE TABLE `historico` (
  ...
  `idPedido` int(11) DEFAULT NULL COMMENT 'Chave identificadora de registros da tabela pedidos',
  `idMateriaPrima` int(11) NOT NULL COMMENT 'Chave identificadora de registros da tabela materia_prima',
  `idPigmento` int(11) DEFAULT NULL COMMENT 'Chave identficadora de Registros da tabela pigmentos',
  `idProduto` int(11) DEFAULT NULL COMMENT 'Chave identificadora de registros da tabela produtos',
  `idMaquina` int(11) DEFAULT NULL COMMENT 'Chave identificadora de registros da tabela maquinas',
  `quantidadeProduto` int(11) DEFAULT NULL COMMENT 'Registra a quantidade de produtos feitos em um pedido',
  `quantidadeMateria_prima` float NOT NULL COMMENT 'Registra a quantidade de matéria prima usada em uma receita',
  `quantidadePigmento` float DEFAULT NULL COMMENT 'registra a quantidade de pigmento usado em uma receita',
  ...
  `statusPedido` tinyint(4) DEFAULT NULL COMMENT 'Registra o status de um pedido da tabela pedidos',
  `obsPedido` text DEFAULT NULL COMMENT 'Registra as observações registradas na tabela pedidos',
  `obsReceita` text DEFAULT NULL COMMENT 'Registra as observações registradas na tabela receitas'
...
INSERT INTO `pedidos` (`idPedido`, `idUsuario`, `idReceita`, `idMaquina`, `dataHora_aberto`, `dataHora_fechado`, `status`, `observacoes`, `quantidade`, `ativo`) VALUES
(1, 4, 2, 1, '2023-11-07 17:19:29', '2023-11-08 19:38:07', 3, 'Perda de produção: 20 produtos.', 60, 1),
(2, 5, 1, 1, '2023-11-07 17:24:39', '0000-00-00 00:00:00', 3, '', 60, 0),
(3, 5, 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, '', 150, 0),
(4, 5, 1, 3, '2023-11-07 19:01:59', '0000-00-00 00:00:00', 2, '', 50, 0),
(5, 5, 2, 3, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, '', 150, 0),
(6, 5, 1, 1, '2023-11-08 19:41:50', '2023-11-08 20:53:42', 3, '', 80, 1);
...
CREATE TABLE `receitas` (
  ...
  `quantidadeMaterial` float NOT NULL COMMENT 'Registra a quantidade de material usado nesta receita',
...
INSERT INTO `receitas` (`idReceita`, `idProduto`, `idPigmento`, `quantidadeMaterial`, `quantidadePigmento`, `observacoes`, `ativo`) VALUES
(1, 12, 5, 45, 15, NULL, 1),
(2, 13, 4, 30, 5, NULL, 1);
...
--
ALTER TABLE `pedidos`
  MODIFY `idPedido` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK - chave identificadora de IDs da tabela pedidos', AUTO_INCREMENT=7;
...
--
ALTER TABLE `receitas`
  MODIFY `idReceita` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK - chave identificadora de IDs da tabela receitas ', AUTO_INCREMENT=3;
...
--
ALTER TABLE `usuarios`
  MODIFY `idUsuario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK - chave identificadora de IDs da tabela usuarios', AUTO_INCREMENT=8;
