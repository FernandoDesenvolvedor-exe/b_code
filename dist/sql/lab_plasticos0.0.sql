...
CREATE TABLE `usuarios` (
  ...
  `idTurma` int(11) COMMENT 'FK - chave estrangeira que Registra a ID da turma do usuário; OBS: Adm não tem turma então não esta definido como chave',
...
--
ALTER TABLE `materia_prima`
  MODIFY `idMateriaPrima` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK - chave identificadora de IDs da tabela materia_prima', AUTO_INCREMENT=7;
