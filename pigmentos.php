        ...
        <div id="main-wrapper">  
            ...
            <div class="page-wrapper">      
                ...
                <div class="container-fluid">
                    ...
                    <!-- MODAL DESATIVA FORNECEDOR -->
                    <div class="modal fade" id="modalDelFornecedor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true ">
                        ...
                        <div class="modal-dialog" role="document ">                                
                            <div class="modal-content">
                                ...
                                <div class="modal-body">                   
                                    ...
                                    <div class="card">
                                        <form method="POST" class="form-horizontal" action= "php/saveFornecedor.php? validacao=I&pg=P">
                                            <div class="card-body">
