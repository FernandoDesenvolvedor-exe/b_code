...
CREATE TABLE `usuarios` (
  ...
  `idTurma` int(11) NULL COMMENT 'FK - chave estrangeira que Registra a ID da turma do usuário',
...
--
ALTER TABLE `usuarios`
  MODIFY `idUsuario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK - chave identificadora de IDs da tabela usuarios', AUTO_INCREMENT=4;
