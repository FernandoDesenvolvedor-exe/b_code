...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06-Dez-2023 às 02:06
...
CREATE TABLE `historico_pedidos` (
  ...
  `quantidadeMateria_prima` float NOT NULL COMMENT 'Registra a quantidade de matéria prima por produto usada em uma receita ',
  `quantidadeReciclado` float NOT NULL COMMENT 'Registro de quantidade de materiais reciclados reutilizados neste pedido',
  `quantidadePigmento` float NOT NULL COMMENT 'registra a quantidade de pigmento usado por produto em uma receita',
