...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14/11/2023 às 21:13
...
CREATE TABLE `historico` (
  ...
  `obsReceita` text CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'Registra as observações registradas na tabela receitas'
...
--
ALTER TABLE `historico`
  MODIFY `idHistorico` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave identificadora de registros da tabela histórico';
