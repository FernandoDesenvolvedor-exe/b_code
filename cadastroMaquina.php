        ...
        <div id="main-wrapper">  
            ...
            <div class="page-wrapper">      
                ...
                <div class="container-fluid">               
                    ...
                    <div class="card">
                        ...
                        <form method="POST" class="form-horizontal" action= "php/saveCadastro.php?validacao=IM">
                            <div class="card-body">
                                ...
                                <!-- Titulo da div -->
                                <h4 class="card-title">Descrição da máquina</h4>
                    ...
                    <div class="card">
                        <form method="POST" class="form-horizontal" action= "php/saveCadastro.php?validacao=we">
                            <div class="card-body">

                                <h4 class="card-title">Descrição do molde</h4>
                                <div class="form-group row">
