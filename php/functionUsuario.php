                                ...
                                ."<div class='modal-dialog' role='document '>"
                                    ."<div class='modal-content'>"
                                        ...
                                        .'<div class="modal-body">'
                                            .'<form method="POST" action="php/saveProdutos.php? validacao=DPF&id='.$campo["idUser"].'">'
                            ...
                            ."<div class='modal fade' id='EditaModal".$campo['idUser']."' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true '>"
                                ."<div class='modal-dialog' role='document '>"
                                    ."<div class='modal-content'>"
                                        ...
                                        .'</div>'                                  
                                        .'<div class="modal-body">'
                                            .'<form method="POST" class="form-horizontal"  enctype="multipart/form-data" action= "php/saveProdutos.php?validacao=UPF&id='.$campo['idUser'].'">'
                                                .'<div class="card-body">'
                                                .''
                                                .'    <!-- turma -->'
