...
*/
    ...
    if ($_GET['validacao'] == 'I'){
        ...
        if (isset($_POST['nNome']) == true && $_POST['nNome'] != ""){  //SE DESCRICAO FOR DIFERENTE DE NULL OU ''
            $sql='UPDATE usuarios SET nome ="'.$_POST['nNome'].'" WHERE idUsuario = '.$_GET['id'].';';
            $result = mysqli_query($conn,$sql);        
        }
        if (isset($_POST['nSobrenome']) == true && $_POST['nSobrenome'] != ""){  //SE DESCRICAO FOR DIFERENTE DE NULL OU ''
            $sql='UPDATE usuarios SET sobrenome ="'.$_POST['Nsobrenome'].'" WHERE idUsuario = '.$_GET['id'].';';
            $result = mysqli_query($conn,$sql);        
        }
        if (isset($_POST['nSenha']) == true && $_POST['nSenha'] != ""){  //SE DESCRICAO FOR DIFERENTE DE NULL OU ''
            $sql='UPDATE usuarios SET senha =md5("'.$_POST['nSenha'].'") WHERE idUsuario = '.$_GET['id'].';';
            $result = mysqli_query($conn,$sql);        
        }
        if (isset($_POST['nTipoUsu']) == true && $_POST['nTipoUsu'] != ""){  //SE DESCRICAO FOR DIFERENTE DE NULL OU ''
        ...
        if (isset($_POST['nTurma']) == true && $_POST['nTurma'] != "null"){  //SE DESCRICAO FOR DIFERENTE DE NULL OU ''
